<div class="bg-gray-900 px-4  sm:px-6">
    <h3 class="text-lg leading-6 font-medium text-white">Coming soon</h3>
            ...
            <div class="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <div id="slider2"
                    ...
                    @foreach($games as $game)
                        <a href="/game/{{$game->slug}}" class="flex flex-shrink-0 relative w-full sm:w-auto">
                            <img src="{{$game->images->where('type', 'cover')->first()->url}}"
...
<script>
    ...
    function goNext() {
        ...
        if (Math.abs(defaultTransform) >= slider2.scrollWidth - 1000) defaultTransform = 0;
