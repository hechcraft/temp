        ...
        <div class="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
            ...
            <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                ...
                <div class="flex-shrink-0 relative ml-5">
                    ...
                    -->
                    <div id="main_menu" class="transform opacity-0 scale-95">
                        <div
                            class="origin-top-right absolute z-50 right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1 focus:outline-none"
    ...
    <nav class="hidden" aria-label="Global" id="mobile_menu">
        <div class="max-w-3xl mx-auto px-2 pt-2 pb-3 space-y-1 sm:px-4">
            ...
            <a href="#" aria-current="page"
               class="bg-gray-100 text-gray-900 hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Dashboard</a>
    ...
    $(document).ready(function () {
        $('#user-menu-button').on({
            mouseenter: function () {
                ...
                $('#main_menu').addClass('transition ease-out duration-100 transform opacity-100 scale-100');
            },
            mouseleave: function () {
                $('#main_menu').removeClass();
                $('#main_menu').addClass('transition ease-in duration-75 transform opacity-0 scale-95');
            }
        });
