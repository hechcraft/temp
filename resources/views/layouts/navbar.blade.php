<header class="bg-white shadow-sm lg:static lg:overflow-y-visible mb-2">
        ...
        <div class="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
            ...
            <div class="min-w-0 flex-1 md:px-8 lg:px-0 xl:col-span-6">
                <form id="gameSearch" method="get" action="{{route('game.search')}}">
                    <div class="flex items-center px-6 py-4 md:max-w-3xl md:mx-auto lg:max-w-none lg:mx-0 xl:px-0">
                        ...
                        <button type="submit"
                                class="ml-2 mt-2 py-2 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
                                      d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
            ...
            <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                @guest
                    ...
                    <a class="ml-3" href="{{route('register')}}">Sign In</a>
                @endguest
                <!-- Profile dropdown -->
                @auth
                    <div class="flex items-center md:order-2">
                        ...
                        <!-- Dropdown menu -->
                        <div
                            class="z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 hidden"
                            id="user-dropdown"
                            ...
                            <ul class="py-1" aria-labelledby="user-menu-button">
                                <li>
                                    <a href="#"
                                       class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Game
                                        List</a>
                                </li>
                                <li>
                                    <a href="#"
    ...
    <nav class="hidden" aria-label="Global" id="mobile_menu">
        @guest
            <div class="max-w-3xl mx-auto px-2 pt-2 pb-3 space-y-1 sm:px-4">
                ...
                <a href="{{route('login')}}" class="hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Log In</a>

                <a href="{{route('register')}}" class="hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Sign In</a>
        ...
        @auth
                <div class="max-w-3xl mx-auto px-2 pt-2 pb-3 space-y-1 sm:px-4">
                    ...
                    <a href="#" class="hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Game List</a>

                    <a href="#" class="hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Profile</a>

                    <a href="{{route('logout')}}" class="hover:bg-gray-50 block rounded-md py-2 px-3 text-base font-medium">Log out</a>
                </div>
